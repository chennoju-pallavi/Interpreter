...
class Lexer:
  ...
  def make_tokens(self):
    ...
    while self.current_char != None:
      ...
      # elif self.current_char == '&':
      #   tokens.append(self.make_bool_and())
      # elif self.current_char == '!':
       # tokens.append(self.make_bool_or())
      elif self.current_char == ',':
...
class ForNode:
  def __init__(self, var_name_tok, start_value_node, end_value_node, step_value_node, body_node, should_return_null):
    ...
    self.pos_start = self.var_name_tok.pos_starta
...
class Parser:
  ...
  def statement(self):
    ...
    if res.error:
      return res.failure(InvalidSyntaxError(
        self.current_tok.pos_start, self.current_tok.pos_end,
        "Expected 'RETURN', 'CONTINUE', 'BREAK', 'LET','VAR', 'IF', 'FOR', 'WHILE', 'FUNC', int, float, identifier, '+', '-', '(', '[' or 'NOT'"
      ))
  ...
  def expr(self):
    ...
    if res.error:
      return res.failure(InvalidSyntaxError(
        self.current_tok.pos_start, self.current_tok.pos_end,
        "Expected 'LET','VAR', 'IF', 'FOR', 'WHILE', 'FUNC', int, float, identifier, '+', '-', '(', '[' or 'NOT'"
      ))
  ...
  def comp_expr(self):
    ...
    node = res.register(self.bin_op(self.arith_expr, (TT_EE, TT_NE, TT_LT, TT_GT, TT_LTE, TT_GTE, TT_AND, TT_OR)))
  ...
  def power(self):
    return self.bin_op(self.call, (TT_MOD, ), self.factor)
